            ...
            <div class="white-background overflow-hidden">
                <div class="col-xs-12 col-sm-12 padding0">
                  <div class="padding20 box-text">
                    <h2><span class="blue">THINGS TO DO & SEE IN LEEDS</span></h2>
...
<!-- About/Team Photo -->
        <div class="row">
            <!-- Sidebar Column -->
            <div class="col-md-3">
                <?php $this->load->view('main/page_components/see_left_navbar'); ?>
            </div>
            <!-- Content Column -->
            <div class="col-md-9">
                <img class="img-rounded img-responsive center-block" src="/assets/images/temple.jpg" alt="">
                <hr>0
