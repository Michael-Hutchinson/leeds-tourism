  ...
  <div class="list-group panel">
    ...
    <div class="collapse" id="<?php echo $left_nav_heading->id; ?>">
        ...
        foreach ($left_nav_sub_heading as $left_nav_sub_heading_details) {
            ...
            if($left_nav_heading->id == $left_nav_sub_heading_details->section_category_id) echo '<a href=/see/page/'.$left_nav_sub_heading_details->id.' class="list-group-item">'.$left_nav_sub_heading_details->name.'</a>';
        }
        } ?>
    </div>
    <?php } ?>
