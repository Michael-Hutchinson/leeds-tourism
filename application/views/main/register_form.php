            ...
            <div class="white-background overflow-hidden">
                <div class="col-xs-12 col-sm-12 padding0">
                  <div class="padding20 box-text">
                    <h2><span class="blue">REGISTER USER</span></h2>
                ...
                <div class="col-md-6 col-md-offset-3">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h4 class="second-header"><i class="fa fa-fw fa-envelope"></i> Please Register Below</h4>
                        </div>
                            <div class="panel-body">
                            <?php print form_open('register_user'); ?>
                                <form>
