    ...
    <div class="content">
      <div class="container">
        ...
        <div class="col-md-9">
        <p><a href="/admin/see/view/add" class="btn btn-primary">Add New Page</a></p>
        <table class="table table-striped table-bordered table-condensed">
            ...
            <?php foreach ($rows as $r) {
                echo '<tr>';
                    echo '<td>'.$r->id.'</td>';
                    echo '<td>'.$r->title.'</td>';
                    echo '<td>'.'<a href="/see/page/'.$r->id.'" class="btn btn-default">View</a>'.'</td>';
                    echo '<td>'.'<a href="/admin/see/view/edit/'.$r->id.'" class="btn btn-info">Edit</a>'.'</td>';
                    echo '<td>'.'<a href="/admin/see/view/delete/'.$r->id.'" onclick="return confirm(\'Are You Sure You Want To Delete This?\');" class="btn btn-danger">Delete</a>'.'</td>';
                echo '</tr>';
            } ?>
            </tbody>
        </table>
