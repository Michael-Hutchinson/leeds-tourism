...
<div class="row">
    <div class="col-lg-12">
        <div class="page-header">
            <h1>Add New Professionals Page</h1>
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Add New Professionals Page</li>
        </ol>
    </div>
</div>
        ...
        <div class="col-md-9">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h4 class="second-header"><i class="fa fa-fw fa-newspaper-o"></i> Add A New Professionals Page Below</h4>
                        </div>
                            <div class="panel-body">
                            <?php print form_open('admin/professionals/view/add'); ?>
                                <form>
