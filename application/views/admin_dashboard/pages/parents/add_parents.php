...
<div class="row">
    <div class="col-lg-12">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="/admin/parents/view">All Pages</a>
            </li>
            <li class="active">Add New Parents Page</li>
        </ol>
    </div>
</div>
        ...
        <div class="col-md-9">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h4 class="second-header"><i class="fa fa-fw fa-newspaper-o"></i> Add A New Parents Page Below</h4>
                        </div>
                            <div class="panel-body">
                            <?php print form_open('admin/parents/view/add'); ?>
                                <form>
